...
inline VkShaderModule CreateShaderModule(VkDevice& device, const uint32_t* byteCode, size_t byteCountSizeInBytes)
{
...
inline VkShaderModule CreateShaderModule(VkDevice& device, const Array<uint32_t>& code)
{
